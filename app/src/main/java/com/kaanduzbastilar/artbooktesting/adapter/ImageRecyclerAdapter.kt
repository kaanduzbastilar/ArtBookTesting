package com.kaanduzbastilar.artbooktesting.adapter
...
class ImageRecyclerAdapter @Inject constructor(val glide: RequestManager) : RecyclerView.Adapter<ImageRecyclerAdapter.ImageViewHolder>() {
    ...
    private var onItemClickListener : ((String) -> Unit) ?= null //url döndürücek o yüzden string unit boş döndürücek şekilde alıyoruz.
